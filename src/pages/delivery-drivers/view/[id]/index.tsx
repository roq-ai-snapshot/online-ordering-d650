...
import { useDeliveryDriverFindFirst, useRoqClient } from 'lib/roq';

import { DeliveryDriverInterface } from 'interfaces/delivery-driver';

function DeliveryDriverViewPage() {
  ...
  const { data, error, isLoading } = useDeliveryDriverFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('delivery_driver', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/delivery-drivers/edit/${id}`} passHref legacyBehavior>
                    <Button
