...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Online Ordering System for Restaurants`}</title>

        <meta
          name="description"
          content="Welcome to Online Ordering System for Restaurants - Your ultimate destination for a free, seamless and efficient food ordering experience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1618066296858-2046a4a39c25?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMjBmb29kJTIwb3JkZXJpbmd8ZW58MHx8fHwxNjk4MDQ3MTE0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@paoloficasso?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Paolo Feser`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Online Ordering System for Restaurants - Your ultimate destination for a free, seamless and efficient food ordering experience.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Restaurant Manager"
