...
export function OrderListPage(props: OrderListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'restaurant', 'order_item.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['order_status.contains'],
          ...params.filters,
        },
        'order',
      ),
  ...
  const columns: ColumnType[] = [
    { id: 'order_status', header: 'Order Status', accessorKey: 'order_status' },
    {
      id: 'order_time',
      header: 'Order Time',
    ...
    },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.delivery_time ? format(record?.delivery_time, 'dd-MM-yyyy') : '',
    },
