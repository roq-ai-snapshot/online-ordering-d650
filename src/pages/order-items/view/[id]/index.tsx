...
import { useOrderItemFindFirst, useRoqClient } from 'lib/roq';
...
function OrderItemViewPage() {
  ...
  const queryParams = useMemo<{ include: { order: boolean; menu: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useOrderItemFindFirst(queryParams, {}, { disabled: !id });
