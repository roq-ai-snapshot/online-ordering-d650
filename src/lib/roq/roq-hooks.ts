...
export function useDeliveryDriverFindMany<
...
>(
  ...
  const key = JSON.stringify(['useDeliveryDriverFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.delivery_driver.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDeliveryDriverCount<T extends Prisma.delivery_driverCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.delivery_driverCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useDeliveryDriverCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.delivery_driver.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDeliveryDriverFindManyWithCount<
  T extends Prisma.delivery_driverFindManyArgs,
  R extends { data: GetFindResult<Prisma.$delivery_driverPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.delivery_driverFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDeliveryDriverFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.delivery_driver.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDeliveryDriverFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDeliveryDriverFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.delivery_driver.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
